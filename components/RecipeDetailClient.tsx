    ...
    <div className="w-full max-w-5xl mx-auto py-6 flex flex-col gap-6 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          {/* Photo */}
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border border-zinc-100 bg-zinc-100">
            <Image
          ...
          <div className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm flex flex-col gap-4">
            <div className="flex justify-between items-center pb-4 border-b border-zinc-100">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-orange-50 hover:bg-orange-100 text-[#ff6b00] text-xs font-bold transition-all active:scale-[0.97]"
              >
                <Heart
                  className={`w-3.5 h-3.5 transition-colors ${
                    isFavorited ? 'fill-red-500 text-red-500' : 'text-[#ff6b00]'
                  }`}
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-sm font-bold text-zinc-700 flex items-center gap-1 capitalize">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6 bg-white p-6 md:p-8 rounded-3xl border border-zinc-100 shadow-sm">
          {/* Header */}
          <div className="flex flex-col gap-2">
            <span className="px-2.5 py-1 rounded-full bg-orange-100 text-[#ff6b00] text-[10px] font-extrabold uppercase tracking-wide self-start">
              Khas {recipe.region}
            </span>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      {isActive && (
                        <span className="text-[9px] text-[#ff6b00] font-bold flex items-center gap-1 mt-1">
